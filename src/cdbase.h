...
public:
    CDbase();
    int openDbase(const QString &filename, const QString &username, const QString &password);
    void close(void);
    int error(void);
    bool isOpen(void);
...
class CMembershipDbase : public CDbase
{
public:
    CMembershipDbase();
...
class CLapsDbase : public CDbase
{
public:
    CLapsDbase();
    int open(QString filename, QString username, QString password);
    int add(const QByteArray &tagId, const QString &firstName, const QString &lastName, const int membershipNumber);
    int update(const QByteArray &tagId, const QString &firstName, const QString &lastName, const int membershipNumber);
    int removeTagId(const QByteArray &tagId);
    int findNameFromTagId(const QByteArray &tagId, QString *firstName, QString *lastName);
    int findTagIdFromName(const QString &firstName, const QString &lastName, QByteArray *tagId);
    int getIdFromTagId(const QByteArray &tagId);
